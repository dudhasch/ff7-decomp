...
void func_800A60D8(void) {
    ...
    for (i = 0; i < 0x1F; i++) {
        off = i * 24;
        *(s32*)(D_80109A38 + off) = off + (s32)(D_80109A38 + 0x18);
    }
    last = i * 24;
    *(s32*)(D_80109A38 + last) = 0;
...
void func_800B392C(void) {
    ...
    p = (u8*)&D_8010D930;
    for (off = 0x1E * 0x74; off >= 0; off -= 0x74) {
        *(u8**)(D_8010CB24 + off) = p;
        p -= 0x74;
    }
    D_8010D930 = 0;
...
void func_800B6A4C(void) {
    u8* p;

    func_800C0808((D_8014A608 >> 2) * 4 + 0x8014A604);
    p = D_8014A610;
    func_800BFBF0(p, 0x8014FC00, 0);
    func_800B6724(p);
    D_80115A48 = 1;
...
void func_800B7714(s32 arg0) {
    ...
    idx = ((((arg0 >> 8) - 1) << 1) & 0x1FE) | (arg0 & 1);
    e = (u8*)(idx * 12 + (s32)D_800BF5F0);
    D_8009ABF6 = *(u16*)(e + 6);
    D_8009ABF8 = *(u16*)(e + 0);
    D_8009ABFA = *(u16*)(e + 2);
    D_8009AC16 = *(u16*)(e + 4);
