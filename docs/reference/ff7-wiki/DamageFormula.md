...
| A | [Physical Accuracy](DamageFormula#0:_Physical_Accuracy_Check "wikilink"), [Critical Check](DamageFormula#2:_Critical_Hit_Check) |
| B | [Physical Accuracy](DamageFormula#0:_Physical_Accuracy_Check "wikilink") |
| C | None (always hits) |
| D | None (always hits) |
| E | None (always hits) |
| F | None (always hits) |
