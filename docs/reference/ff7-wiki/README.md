...
- Internal links that pointed to `FF7/...` were rewritten to local relative paths where possible.

If you need different link mapping (e.g., keep `FF7/...` prefixes), edit `tools/fix_links_ff7.py` and re-run it.
