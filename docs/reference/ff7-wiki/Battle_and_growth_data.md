...
Section contains 24-byte header representing 2-bytes per script block (1 per character?). Each number is an offset from the beginning of this block to the actual AI data. Each script block follows the same AI data found in the [Battle Scenes](Battle/Battle_scenes#AI_Data "wikilink"). A basic disassembly of the characters' scripts can be found [here](http://forums.qhimm.com/index.php?topic=7928.msg97889#msg97889)
