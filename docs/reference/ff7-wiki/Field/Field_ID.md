...
Field IDs are used internally by scripts to reference fields, for example with the [MAPJUMP](Field/Script/Opcodes/60_MAPJUMP "wikilink") and [LSTMP](Script/Opcodes/6E_LSTMP) opcodes.
