...
Similar to [BGON](Field/Script/Opcodes/E0_BGON "wikilink"), only this opcode turns *off* the portion of background whose [background sprite](../../Sprite) specifies it as belonging to the scripted area and layer specified.
