...
Neither animation nor sound is specified in this opcode. An animation is played by using an animation opcode such as [DFANM](Field/Script/Opcodes/A2_DFANM "wikilink"), and a [SOUND](F1_SOUND) played, before the jump.
