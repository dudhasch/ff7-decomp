...
The mode of the window should be changed before it is displayed with [MESSAGE](Field/Script/Opcodes/40_MESSAGE "wikilink") or [ASK](48_ASK), or the changes will not be visible unless the window is closed and reopened.
